 ...
 * RegexValidatorCor validator = new RegexValidatorCor(regexs, false);
 * </code>
 * </pre>
 *
 * <ul>
 ...
 * @since Validator 1.4
 */
public class RegexValidatorCor implements Serializable {
     ...
     * validate against
     */
    public RegexValidatorCor(String regex) {
        this(regex, true);
    }
     ...
     */
    public RegexValidatorCor(String regex, boolean caseSensitive) {
     ...
     * validate against
     */
    public RegexValidatorCor(String[] regexs) {
        this(regexs, true);
    }
     ...
     * sensitive</i>, otherwise matching is <i>case in-sensitive</i>
     */
    public RegexValidatorCor(String[] regexs, boolean caseSensitive) {
    ...
    public String toString() {
        StringBuilder buffer = new StringBuilder();
        buffer.append("RegexValidatorCor{");
        for (int i = 0; i < patterns.length; i++) {
            if (i > 0) {
                buffer.append(",");
            }
