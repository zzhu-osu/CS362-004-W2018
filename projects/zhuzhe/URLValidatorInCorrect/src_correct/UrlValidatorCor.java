 ...
 * <pre>
 *   Example of usage:
 *   Construct a UrlValidatorCor with valid schemes of "http", and "https".
 *
 *    String[] schemes = {"http","https"}.
 *    UrlValidatorCor urlValidator = new UrlValidatorCor(schemes);
 ...
 *
 *    UrlValidatorCor urlValidator = new UrlValidatorCor();
 *    if (urlValidator.isValid("ftp://foo.bar.com/")) {
 *       System.out.println("url is valid");
 *    } else {
 *       System.out.println("url is invalid");
 ...
 * @since Validator 1.4
 */
public class UrlValidatorCor implements Serializable {
     ...
     *  a {@link RegexValidatorCor} instead ({@link #UrlValidatorCor(RegexValidatorCor, long)})
     */
     ...
     */
    private final RegexValidatorCor authorityValidator;
     ...
     */
    private static final UrlValidatorCor DEFAULT_URL_VALIDATOR = new UrlValidatorCor();

    /**
     * Returns the singleton instance of this class with default schemes and options.
     * @return singleton instance with default schemes and options
     */
    public static UrlValidatorCor getInstance() {
        return DEFAULT_URL_VALIDATOR;
    }

    /**
     * Create a UrlValidatorCor with default properties.
     */
    public UrlValidatorCor() {
        this(null);
    }
     ...
     */
    public UrlValidatorCor(String[] schemes) {
        this(schemes, 0L);
    }

    /**
     * Initialize a UrlValidatorCor with the given validation options.
     * @param options The options should be set using the public constants declared in
     * this class.  To set multiple options you simply add them together.  For example,
     * ALLOW_2_SLASHES + NO_FRAGMENTS enables both of those options.
     */
    public UrlValidatorCor(long options) {
     ...
     * ALLOW_2_SLASHES + NO_FRAGMENTS enables both of those options.
     */
    public UrlValidatorCor(String[] schemes, long options) {
     ...
     */
    public UrlValidatorCor(RegexValidatorCor authorityValidator, long options) {
     ...
     * enables both of those options.
     */
    public UrlValidatorCor(String[] schemes, RegexValidatorCor authorityValidator, long options) {
     ...
     * Note: this implementation validates the domain unless a RegexValidatorCor was provided.
     * If a RegexValidatorCor was supplied and it matches, then the authority is regarded
     * as valid with no further checks, otherwise the method checks against the
     * AUTHORITY_PATTERN and the DomainValidatorCor (ALLOW_LOCAL_URLS)
    ...
    protected boolean isValidAuthority(String authority) {
        ...
        final String authorityASCII = DomainValidatorCor.unicodeToASCII(authority);
        ...
        if (ipv6 != null) {
            InetAddressValidatorCor inetAddressValidator = InetAddressValidatorCor.getInstance();
            ...
            DomainValidatorCor domainValidator = DomainValidatorCor.getInstance(isOn(ALLOW_LOCAL_URLS));
