 ...
 * @since Validator 1.4
 */
public class DomainValidatorCor implements Serializable {
     ...
     */
    private static final DomainValidatorCor DOMAIN_VALIDATOR = new DomainValidatorCor(false);

    /**
     * Singleton instance of this validator, which does
     *  consider local addresses valid.
     */
    private static final DomainValidatorCor DOMAIN_VALIDATOR_WITH_LOCAL = new DomainValidatorCor(true);

    /**
     * RegexValidatorCor for matching domains.
     */
    private final RegexValidatorCor domainRegex =
            new RegexValidatorCor(DOMAIN_NAME_REGEX);
    /**
     * RegexValidatorCor for matching a local hostname
     */
    // RFC1123 sec 2.1 allows hostnames to start with a digit
    private final RegexValidatorCor hostnameRegex =
            new RegexValidatorCor(DOMAIN_LABEL_REGEX);
     ...
     */
    public static synchronized DomainValidatorCor getInstance() {
        inUse = true;
     ...
     * @return the singleton instance of this validator
     */
    public static synchronized DomainValidatorCor getInstance(boolean allowLocal) {
        inUse = true;
        if(allowLocal) {
    ...
    /** Private constructor. */
    private DomainValidatorCor(boolean allowLocal) {
...
//        "mutuelle", // mutuelle Fédération Nationale de la Mutualité Française (Retired)
        ...
        "xn--11b4c3d", // कॉ�? VeriSign Sarl
        "xn--1ck2e1b", // セー�? Amazon Registry Services, Inc.
        ...
        "xn--6qq986b3xl", // 我爱�? Tycoon Treasure Limited
        ...
        "xn--8y0a063a", // 联�?? China United Network Communications Corporation Limited
        ...
        "xn--b4w605ferd", // 淡马�? Temasek Holdings (Private) Limited
        "xn--bck1b9a5dre4c", // ファッション Amazon Registry Services, Inc.
        "xn--c1avg", // орг Public Interest Registry
        "xn--c2br7g", // ने�? VeriSign Sarl
        "xn--cck2b3b", // スト�? Amazon Registry Services, Inc.
        ...
        "xn--efvy88h", // 新闻 Xinhua News Agency Guangdong Branch 新华通讯社广东分�?
        ...
        "xn--fiq228c5hs", // 中文�? TLD REGISTRY LIMITED
        ...
        "xn--i1b6b1a6a2e", // संगठ�? Public Interest Registry
        ...
        "xn--jlq61u9w7b", // 诺基�? Nokia Corporation
        "xn--jvr189m", // 食品 Amazon Registry Services, Inc.
        "xn--kcrx77d1x4a", // 飞利�? Koninklijke Philips N.V.
        ...
        "xn--q9jyb4c", // みん�? Charleston Road Registry Inc.
        ...
        "xn--tiq49xqyj", // 天主�? Pontificium Consilium de Comunicationibus Socialibus (PCCS) (Pontifical Council for Social Communication)
        ...
        "xn--w4r85el8fhu5dnra", // 嘉里大酒�? Kerry Trading Co. Limited
...
//        "tp",                 // East Timor (Retired)
        ...
        "xn--54b7fta0cc", // বাংল�? Posts and Telecommunications Division
        ...
        "xn--clchc0ea0b2g2a9gcd", // சிங்கப்பூர�? Singapore Network Information Centre (SGNIC) Pte Ltd
        ...
        "xn--o3cw4h", // ไท�? Thai Network Information Center Foundation
        ...
        "xn--xkc2dl3a5ee0h", // இந்திய�? National Internet Exchange of India
    ...
    /**
     * enum used by {@link DomainValidatorCor#updateTLDOverride(ArrayType, String[])}
     ...
     * For example:
     * <p>
     * {@code DomainValidatorCor.updateTLDOverride(ArrayType.GENERIC_PLUS, new String[]{"apache"})}
     * <p>
     * To clear an override array, provide an empty array.
     *
     * @param table the table to update, see {@link DomainValidatorCor.ArrayType}
